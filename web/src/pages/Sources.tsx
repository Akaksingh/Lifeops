...
import { mockExtraction } from '../lib/data';
...
export default function SourcesPage() {
  ...
  // Same sync path the dashboard uses: extract (mock, client-side), write new rows to Lemma.
      ...
      <div className="mt-5 rounded-2xl border border-amber-200 bg-amber-50 p-4 flex items-start gap-3">
        ...
        <div className="text-sm text-amber-800">
          ...
          <p className="text-amber-700/90 mt-0.5">
            Sources return realistic sample data so the loop is demoable. Real extraction (Gmail / Calendar /
            Notion / Drive via the Anthropic MCP connector) runs in the Next.js server build — not in this
            hosted client app.
          </p>
        </div>
      </div>
