...
function ReminderChannels() {
  // Floater = browser notifications (fully client-side, works in the hosted app).
  // Email/SMS/Call need the Next.js server (Resend/Twilio), so they're Pro/unavailable here.
  ...
  return (
    <>
      ...
      <ChannelRow icon={<Mail className="w-4 h-4" />} label="Email Digest" pro />
